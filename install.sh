#!/usr/bin/env bash
# Installs the systemd user unit and the autostart entry, resolving every path
# from wherever this repository happens to sit. Re-run it after editing
# flm.service, since the installed copy is a copy and not a symlink.
set -euo pipefail
